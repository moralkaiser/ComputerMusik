...
// Class based on the CSharpSynthForUnity-Projekt by Chad Carter
...
public class MIDISequencer : MonoBehaviour
{
	...
	void Awake()
	{
		...
		//midiStreamSynthesizer.NoteOn(0, 20, midiNoteVolume, 1);
	...
	public void playDrum(int note)
	{
		midiStreamSynthesizer.NoteOn(9, note, midiNoteVolume, 0);
	}
	...
	public void stopDrum(int note)
	{
		midiStreamSynthesizer.NoteOff(9, note);
	}
